...
- **Global CLAUDE.md**: are there any steering instructions that should be moved to coding standards (or automated checks) instead? _Use when_ the CLAUDE.md file is particularly large - in the repo (`./CLAUDE.md`) OR the user's global scope (`~/.claude/CLAUDE.md`).
...
- `CLAUDE.md`: this file is pushed to the context window of every Claude session working in this repo. They should be used incredibly sparingly, usually only for **navigation pointers** to other files.
