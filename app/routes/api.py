...
def get_or_404(model_class, model_id, error_message):
    obj = db.session.get(model_class, model_id)
    if not obj:
...
def delete_exercise(exercise_id):
    ...
    exercise = get_or_404(Exercise, exercise_id, "Exercise not found")
...
def delete_machine(machine_id):
    """Delete a machine."""
    machine = get_or_404(Machine, machine_id, "Machine not found")
...
def get_routine(routine_id):
    ...
    routine = get_or_404(Routine, routine_id, "Routine not found")
...
def get_session(session_id):
    ...
    session = get_or_404(Session, session_id, "Session not found")
...
def switch_entry_machine(entry_id):
    ...
    entry = get_or_404(SessionEntry, entry_id, "Session entry not found")
...
def update_set(set_id):
    ...
    s = get_or_404(SessionSet, set_id, "Set not found")
